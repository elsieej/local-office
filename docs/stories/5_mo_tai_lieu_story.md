...
- [ ] File đúng định dạng hỗ trợ (`.docx` `.doc` `.xlsx` `.xls` `.pptx` `.ppt` `.pdf`) nhưng không phải PDF vẫn lưu và liệt kê được — chỉ chưa xem được (xem [US-7](7_xem_pdf_cuc_bo_story.md))
...
- [ ] [TASK-13: Vùng kéo–thả / chọn file](../tasks/13_vung_keo_tha_task.md) · #TBD
